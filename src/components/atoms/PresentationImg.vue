<template>
  ...
  >
    ...
    <g id="Grupo_1" data-name="Grupo 1" transform="translate(-506.602 -219)">
      <path
        id="Folha2"
        d="M1143.69,610.429s-18.133-60.441,38.279-75.551C1181.969,534.878,1202.116,601.363,1143.69,610.429Z"
        transform="translate(0 -66.848)"
        fill="url(#linear-gradient)"
      />
      <path
        id="Folha1"
        d="M1144.737,626.487s33.48-87.295,113.313-53.921C1258.05,572.566,1221.459,668.773,1144.737,626.487Z"
        transform="translate(0 -66.848)"
        fill="url(#linear-gradient)"
      />
      <circle
        id="Circulo_Bg"
        data-name="Circulo Bg"
        cx="188.06"
        cy="188.06"
        r="188.06"
        transform="translate(776.386 219)"
        opacity="0.5"
        fill="url(#linear-gradient-3)"
      />
      <g
        id="Box_Marcos"
        data-name="Box Marcos"
        transform="translate(0 -66.848)"
      >
        <circle
          id="Elipse_8"
          ...
          cy="158.785"
          r="158.785"
          transform="translate(615.545 334.017)"
          opacity="0.2"
        ...
        <g transform="matrix(1, 0, 0, 1, 506.6, 285.85)" filter="url(#Box)">
          <rect
            ...
            height="103.814"
            rx="32.63"
            transform="translate(112.57 133.82)"
            fill="#fff"
          />
        </g>
        <path
        ...
        <g id="vento2">
          <path
            ...
            d="M646.955,483.6a16.523,16.523,0,0,0,8.887,9.953"
            fill="none"
            stroke="#9f6d62"
          ...
          <path
            ...
            d="M638.615,486.8a22.42,22.42,0,0,0,12.06,13.507"
            fill="none"
            stroke="#9f6d62"
            stroke-linecap="round"
            stroke-linejoin="round"
        ...
        <g id="vento1">
          <path
            ...
            d="M700.109,453.74a16.52,16.52,0,0,0-8.886-9.953"
            fill="none"
            stroke="#9f6d62"
            stroke-linecap="round"
            stroke-linejoin="round"
          ...
          <path
            ...
            d="M708.45,450.541a22.423,22.423,0,0,0-12.06-13.508"
            fill="none"
            stroke="#9f6d62"
            stroke-linecap="round"
            stroke-linejoin="round"
      ...
      <g id="Marcos" transform="translate(0 -66.848)">
        <rect
          ...
          height="86.172"
          rx="43.086"
          transform="translate(859.806 579.37)"
        ...
        <circle
          ...
          cy="17.822"
          r="17.822"
          transform="translate(1016.976 418.231)"
          fill="#7e5a4e"
        />
        <circle
          id="Orelha1"
          ...
          cy="17.822"
          r="17.822"
          transform="translate(902.021 446.747)"
          fill="#7e5a4e"
        />
        <path
          id="Pescoço"
          d="M922.8,468.692s30.213,72.277-9.594,112.084c0,0,34.5,38.038,82.268,38.038s84.036-38.922,84.036-38.922-53.6-26.625-43.165-134.5Z"
          fill="#7e5a4e"
        />
        <rect
          id="Rosto"
          ...
          height="155.508"
          rx="57.956"
          transform="matrix(0.98, -0.201, 0.201, 0.98, 903.185, 373.131)"
          fill="#9f6d62"
        />
        <path
          id="sorriso"
          d="M1017.378,479.406a56.808,56.808,0,0,1-54.55,14.581l-1.2-7.181,6.49-.64a20.788,20.788,0,0,1-6.96-2.17l-1.63-9.759s28.69,6.109,55.5-8.94Z"
          fill="#eef2f6"
        />
        <rect
          id="Nariz"
          ...
          height="47.423"
          rx="12.691"
          transform="translate(971.466 419.602) rotate(-13.883)"
          fill="#ff895f"
        />
        <circle
          id="Olho2"
          ...
          cy="4.456"
          r="4.456"
          transform="translate(999.423 414.04)"
          fill="#141f36"
        />
        <circle
          id="Olho1"
          ...
          cy="4.456"
          r="4.456"
          transform="translate(942.391 426.516)"
          fill="#141f36"
        />
        <rect
          id="sombrancelha2"
          ...
          height="14.075"
          rx="7.038"
          transform="translate(930.106 412.069) rotate(-20.851)"
          fill="#141f36"
        />
        <rect
          id="sombrancelha1"
          ...
          height="14.075"
          rx="7.038"
          transform="matrix(0.949, -0.314, 0.314, 0.949, 977.063, 381.095)"
          fill="#141f36"
        />
      </g>
      <circle
        ...
        cy="17.519"
        r="17.519"
        transform="translate(543.926 306.943)"
      ...
      <circle
        ...
        cy="9.381"
        r="9.381"
        transform="translate(708.521 589.312)"
        fill="url(#linear-gradient-5)"
      />
      <circle
        id="Elipse_16"
        ...
        cy="9.381"
        r="9.381"
        transform="translate(1440.123 499.089)"
        fill="url(#linear-gradient-5)"
      />
      <circle
        id="Elipse_17"
        ...
        cy="38.741"
        r="38.741"
        transform="translate(906.286 564.826)"
        fill="url(#linear-gradient-5)"
      />
      <circle
        id="Elipse_18"
        ...
        cy="34.328"
        r="34.328"
        transform="translate(1277.863 499.089)"
        fill="url(#linear-gradient-5)"
      />
      <g id="_" data-name="&lt;/&gt;" transform="translate(0 -66.848)">
        <path
          id="_2"
          data-name="&gt;"
          d="M1114.655,517.2l22.909-22.909-22.909-22.909"
          fill="none"
          stroke="#935e92"
          stroke-linejoin="round"
          stroke-width="18"
        ...
        <path
          id="_3"
          data-name="&lt;"
          d="M822.639,596.759l-22.909,22.909,22.909,22.909"
          fill="none"
          stroke="#935e92"
          stroke-linejoin="round"
          stroke-width="18"
        ...
        <line
          ...
          x1="15.51"
          y2="75.888"
          transform="translate(1071.416 451.597)"
          fill="none"
          stroke="#935e92"
          stroke-linejoin="round"
          stroke-width="18"
      ...
      <g id="Teclado">
        <circle
          id="Sombra_teclado"
          data-name="Sombra teclado"
          cx="69.293"
          cy="69.293"
          r="69.293"
          transform="translate(1162.294 399.138)"
          opacity="0.2"
          fill="url(#radial-gradient-3)"
        />
        <rect
          id="Retângulo_250"
          data-name="Retângulo 250"
          width="200.053"
          height="75.346"
          rx="8.435"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1187.081, 431.442)"
          fill="none"
          stroke="#fff"
          stroke-linecap="round"
          stroke-linejoin="round"
        ...
        <rect
          id="Retângulo_251"
          data-name="Retângulo 251"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1199.916, 489.526)"
          fill="#fff"
        />
        <rect
          id="Retângulo_252"
          data-name="Retângulo 252"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1191.189, 433.768)"
          fill="#fff"
        />
        <rect
          id="Retângulo_253"
          data-name="Retângulo 253"
          width="23.552"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1197.734, 475.586)"
          fill="#fff"
        />
        <rect
          id="Retângulo_254"
          data-name="Retângulo 254"
          width="23.552"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1193.371, 447.707)"
          fill="#fff"
        />
        <rect
          id="Retângulo_255"
          data-name="Retângulo 255"
          width="31.506"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1195.553, 461.647)"
          fill="#fff"
        />
        <rect
          id="Retângulo_256"
          data-name="Retângulo 256"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1214.523, 487.24)"
          fill="#fff"
        />
        <rect
          id="Retângulo_257"
          ...
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1223.386, 471.572)"
          fill="#fff"
        />
        <rect
          id="Retângulo_258"
          ...
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1238.168, 469.258)"
          fill="#fff"
        />
        <rect
          id="Retângulo_259"
          ...
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1252.949, 466.945)"
          fill="#fff"
        />
        <rect
          id="Retângulo_260"
          ...
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1267.731, 464.631)"
          fill="#fff"
        />
        <rect
          id="Retângulo_261"
          ...
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1282.513, 462.318)"
          fill="#fff"
        />
        <rect
          id="Retângulo_262"
          data-name="Retângulo 262"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1297.295, 460.004)"
          fill="#fff"
        />
        <rect
          id="Retângulo_263"
          data-name="Retângulo 263"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1312.077, 457.691)"
          fill="#fff"
        />
        <rect
          id="Retângulo_264"
          ...
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1326.859, 455.377)"
          fill="#fff"
        />
        <rect
          id="Retângulo_265"
          ...
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1341.641, 453.064)"
          fill="#fff"
        />
        <rect
          id="Retângulo_266"
          data-name="Retângulo 266"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1219.022, 443.693)"
          fill="#fff"
        />
        <rect
          id="Retângulo_267"
          ...
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1233.804, 441.379)"
          fill="#fff"
        />
        <rect
          id="Retângulo_268"
          data-name="Retângulo 268"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1248.586, 439.066)"
          fill="#fff"
        />
        <rect
          id="Retângulo_269"
          data-name="Retângulo 269"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1263.368, 436.752)"
          fill="#fff"
        />
        <rect
          id="Retângulo_270"
          data-name="Retângulo 270"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1278.15, 434.439)"
          fill="#fff"
        />
        <rect
          id="Retângulo_271"
          ...
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1292.932, 432.125)"
          fill="#fff"
        />
        <rect
          id="Retângulo_272"
          data-name="Retângulo 272"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1307.714, 429.812)"
          fill="#fff"
        />
        <rect
          id="Retângulo_273"
          data-name="Retângulo 273"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1322.496, 427.498)"
          fill="#fff"
        />
        <rect
          id="Retângulo_274"
          data-name="Retângulo 274"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1337.278, 425.185)"
          fill="#fff"
        />
        <rect
          id="Retângulo_275"
          data-name="Retângulo 275"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1352.337, 422.828)"
          fill="#fff"
        />
        <rect
          id="Retângulo_276"
          data-name="Retângulo 276"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1206.335, 431.474)"
          fill="#fff"
        />
        <rect
          id="Retângulo_277"
          data-name="Retângulo 277"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1221.117, 429.161)"
          fill="#fff"
        />
        <rect
          id="Retângulo_278"
          data-name="Retângulo 278"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1235.899, 426.847)"
          fill="#fff"
        />
        <rect
          id="Retângulo_279"
          data-name="Retângulo 279"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1250.681, 424.534)"
          fill="#fff"
        />
        <rect
          id="Retângulo_280"
          data-name="Retângulo 280"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1265.463, 422.22)"
          fill="#fff"
        />
        <rect
          id="Retângulo_281"
          data-name="Retângulo 281"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1280.244, 419.907)"
          fill="#fff"
        />
        <rect
          id="Retângulo_282"
          data-name="Retângulo 282"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1295.026, 417.594)"
          fill="#fff"
        />
        <rect
          id="Retângulo_283"
          data-name="Retângulo 283"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1309.808, 415.28)"
          fill="#fff"
        />
        <rect
          id="Retângulo_284"
          data-name="Retângulo 284"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1324.59, 412.967)"
          fill="#fff"
        />
        <rect
          id="Retângulo_285"
          data-name="Retângulo 285"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1339.65, 410.61)"
          fill="#fff"
        />
        <rect
          id="Retângulo_286"
          data-name="Retângulo 286"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1229.448, 456.342)"
          fill="#fff"
        />
        <rect
          id="Retângulo_287"
          data-name="Retângulo 287"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1244.23, 454.028)"
          fill="#fff"
        />
        <rect
          id="Retângulo_288"
          data-name="Retângulo 288"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1259.012, 451.715)"
          fill="#fff"
        />
        <rect
          id="Retângulo_289"
          data-name="Retângulo 289"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1273.794, 449.401)"
          fill="#fff"
        />
        <rect
          id="Retângulo_290"
          data-name="Retângulo 290"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1288.575, 447.088)"
          fill="#fff"
        />
        <rect
          id="Retângulo_291"
          data-name="Retângulo 291"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1303.357, 444.775)"
          fill="#fff"
        />
        <rect
          id="Retângulo_292"
          data-name="Retângulo 292"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1318.139, 442.461)"
          fill="#fff"
        />
        <rect
          id="Retângulo_293"
          data-name="Retângulo 293"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1332.921, 440.148)"
          fill="#fff"
        />
        <rect
          id="Retângulo_294"
          data-name="Retângulo 294"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1347.703, 437.834)"
          fill="#fff"
        />
        <rect
          id="Retângulo_295"
          data-name="Retângulo 295"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1362.381, 435.537)"
          fill="#fff"
        />
        <rect
          id="Retângulo_296"
          data-name="Retângulo 296"
          width="16.955"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1332.219, 468.819)"
          fill="#fff"
        />
        <rect
          id="Retângulo_297"
          data-name="Retângulo 297"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1351.267, 465.838)"
          fill="#fff"
        />
        <rect
          id="Retângulo_298"
          data-name="Retângulo 298"
          width="12.778"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1377.9, 461.67)"
          fill="#fff"
        />
        <rect
          id="Retângulo_299"
          data-name="Retângulo 299"
          width="32.896"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1355.842, 450.841)"
          fill="#fff"
        />
        <rect
          id="Retângulo_300"
          data-name="Retângulo 300"
          width="27.531"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1354.598, 408.193)"
          fill="#fff"
        />
        <path
          id="Caminho_22"
          data-name="Caminho 22"
          d="M1383.979,417.876l4.314,26.312-9.37,1.466-2.17-13.868-7.3,1.143-1.952-12.474Z"
          fill="#fff"
        />
        <rect
          id="Retângulo_301"
          data-name="Retângulo 301"
          width="12.778"
          height="5.753"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1364.546, 463.76)"
          fill="#fff"
        />
        <rect
          id="Retângulo_302"
          data-name="Retângulo 302"
          width="12.778"
          height="5.789"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1365.588, 470.423)"
          fill="#fff"
        />
        <rect
          id="Retângulo_303"
          ...
          width="102.145"
          height="12.511"
          transform="matrix(0.988, -0.155, 0.155, 0.988, 1229.129, 484.954)"
          fill="#fff"
        />
      </g>
      <g id="Elipse" transform="translate(0 -66.848)">
        <circle
          ...
          cy="12.687"
          r="12.687"
          transform="translate(1220.4 520.415)"
          fill="#fff"
        />
        <circle
          id="Elipse_20"
          ...
          cy="12.687"
          r="12.687"
          transform="translate(1160.579 302.738)"
          fill="#fff"
        />
        <circle
          id="Elipse_21"
          ...
          cy="5.97"
          r="5.97"
          transform="translate(1437.564 452.504)"
          fill="#fff"
        />
        <circle
          id="Elipse_22"
          ...
          cy="5.97"
          r="5.97"
          transform="translate(662.959 570.617)"
          fill="#fff"
        />
      </g>
      <g id="Box_infos" data-name="Box infos" transform="translate(0 -66.848)">
        <g id="Box_infos-2" data-name="Box infos">
          <g
            transform="matrix(1, 0, 0, 1, 506.6, 285.85)"
            filter="url(#Retângulo_305)"
          >
            <rect
              id="Retângulo_305-2"
              data-name="Retângulo 305"
              width="314.79"
              height="103.814"
              rx="32.63"
              transform="translate(544.46 324.86)"
              fill="#fff"
            />
          </g>
          <path
      ...
      <g id="Servidor" transform="translate(0 -66.848)">
        <circle
          id="Sombra_servidor"
          data-name="Sombra servidor"
          cx="69.293"
          cy="69.293"
          r="69.293"
          transform="translate(508.563 524.511)"
          opacity="0.15"
        ...
        <rect
          ...
          width="102.985"
          height="31.343"
          transform="matrix(0.994, 0.111, -0.111, 0.994, 510.072, 597.871)"
          fill="#fff"
        />
        <rect
          id="linha"
          width="31.167"
          height="9.486"
          transform="matrix(0.994, 0.111, -0.111, 0.994, 521.972, 610.193)"
          fill="#eef2f6"
        />
        <g id="circulos">
          <rect
            id="Retângulo_308"
            data-name="Retângulo 308"
            width="8.113"
            height="8.821"
            transform="matrix(0.994, 0.111, -0.111, 0.994, 568.412, 615.366)"
            fill="#eef2f6"
          />
          <rect
            id="Retângulo_309"
            ...
            width="8.113"
            height="8.821"
            transform="matrix(0.994, 0.111, -0.111, 0.994, 578.872, 616.531)"
            fill="#eef2f6"
          />
          <rect
            id="Retângulo_310"
            data-name="Retângulo 310"
            width="8.113"
            height="8.821"
            transform="matrix(0.994, 0.111, -0.111, 0.994, 589.332, 617.696)"
            fill="#eef2f6"
          />
        </g>
        <rect
          ...
          width="84.069"
          height="8.769"
          transform="matrix(0.994, 0.111, -0.111, 0.994, 520.159, 592.747)"
          fill="#fff"
        />
        <rect
          id="Box_base-2"
          ...
          width="102.985"
          height="31.343"
          transform="matrix(0.994, 0.111, -0.111, 0.994, 513.935, 563.188)"
          fill="#fff"
        />
        <rect
          id="linha-2"
          ...
          width="31.167"
          height="9.486"
          transform="matrix(0.994, 0.111, -0.111, 0.994, 525.836, 575.51)"
          fill="#eef2f6"
        />
        <g id="circulos-2" data-name="circulos">
          <rect
            id="Retângulo_314"
            data-name="Retângulo 314"
            width="8.113"
            height="8.821"
            transform="matrix(0.994, 0.111, -0.111, 0.994, 572.275, 580.683)"
            fill="#eef2f6"
          />
          <rect
            id="Retângulo_315"
            data-name="Retângulo 315"
            width="8.113"
            height="8.821"
            transform="matrix(0.994, 0.111, -0.111, 0.994, 582.735, 581.848)"
            fill="#eef2f6"
          />
          <rect
            id="Retângulo_316"
            data-name="Retângulo 316"
            width="8.113"
            height="8.821"
            transform="matrix(0.994, 0.111, -0.111, 0.994, 593.195, 583.013)"
            fill="#eef2f6"
          />
        </g>
      </g>
